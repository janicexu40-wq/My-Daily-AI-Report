...
1. 每天早上任务完成后，MP3 音频会自动上传到你的阿里云盘 **/晨间情报** 文件夹。  
2. 打开 **阿里云盘 App**，找到当天日期的文件直接播放。
...
1. 手机收到 **Bark** 通知的推送。  
2. **点击通知**，直接跳转到当天的精美 HTML 情报页（内置播放器）。  
3. **网页示例地址**：  
   https://janicexu40-wq.github.io/My-Daily-AI-Report/output/briefing\_20260201.html  
...
| 密钥名称 | 说明 | 获取方式 |
| :---- | :---- | :---- |
| DASHSCOPE\_API\_KEY | 阿里云通义千问 API | [阿里云百炼平台](https://dashscope.console.aliyun.com/) |
| BARK\_KEY | iPhone 推送通知密钥 | App Store 下载 [Bark](https://apps.apple.com/us/app/bark-customed-notifications/id1403753865) |
| ALIYUN\_REFRESH\_TOKEN | 阿里云盘上传凭证 | 获取 Refresh Token 用于网盘自动上传 |
...
output/  
├── briefing\_20260201.mp3   \# 🎙️ 音频 (上传至阿里云盘)  
├── briefing\_20260201.html  \# 📱 网页 (Bark 跳转)  
├── briefing\_20260201.md    \# 📝 Markdown 原稿  
└── briefing\_20260201.txt   \# (纯文本备份)  
feed.xml                    \# 📡 RSS 订阅源  
